export const languageStringsEnglish = {
  translation: {
    ...
    SUBSCRIPTION_UPSELL: "ChatGPT skill is free for the first five interactions. Please say <break time=\'0.3s\'/> buy subscription <break time=\'0.3s\'/> to get unlimited amount of access for a year."
  }
};
